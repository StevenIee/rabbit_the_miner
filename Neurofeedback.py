        ...
        while run:
            ...
            if game_starter:
                if game_status == "intro":
                    ...
                    game_status, game_status_old, resting_start = GP.resting(self.screen, game_status, game_status_old, de_x, de_y, resting_back, rest_ins, all_sprites, button_jstart, resting_start, eye_1, mt)#, resting_eye )
