...
class Neurofeedback:
    def __init__(self, player_id, player_session, player_datafile):
        ...
        # images
        background_img, method_back, resting_back, game_back, title_gold, title_word, rest_title, pause_title, method, rest_ins, rest_expl, rest_rep, game_pauseb = AS.back_img(de_x, de_y)
        # objects
